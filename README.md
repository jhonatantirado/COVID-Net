...
3. Use the Jupyter notebook [create\_COVIDx\_v3.ipynb](create_COVIDx_v2.ipynb) to combine the two datasets to create COVIDx. Make sure to remember to change the file paths.
